...
class AuthorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'book_authors_book_id' => ['type' => 'index', 'columns' => ['book_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'book_authors_book_id' => ['type' => 'foreign', 'columns' => ['book_id'], 'references' => ['books', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-07-14 05:54:42',
                'modified' => '2020-07-14 05:54:42',
            ],
        ];
        parent::init();
    }
