...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'length' => 150, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_vietnamese_ci', 'comment' => '', 'precision' => null],
        'password' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_vietnamese_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-07-14 09:05:25',
                'modified' => '2020-07-14 09:05:25',
            ],
        ];
        parent::init();
    }
